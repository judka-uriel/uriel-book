...
URIEL_C_PDF  = files/book/$(OUT_SUBDIR)/Uriel_with_comments_ru.pdf

URIEL_EN_MD   = uriel_en.md
URIEL_EN_HTML = en/book/$(OUT_SUBDIR)/uriel.html
URIEL_EN_PDF  = files/book/en/$(OUT_SUBDIR)/Uriel.pdf

URIEL_EN_C_HTML = en/book/$(OUT_SUBDIR)/uriel_with_comments.html
URIEL_EN_C_PDF  = files/book/en/$(OUT_SUBDIR)/Uriel_with_comments.pdf

all: $(URIEL_PDF) $(URIEL_EN_PDF) $(URIEL_C_HTML) $(URIEL_EN_C_HTML) # $(URIEL_C_PDF) $(URIEL_EN_C_PDF)
